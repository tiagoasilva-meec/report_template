...
\begin{table}[h]
    ...
    \begin{tabular}{|c|}
        ...
        \textbf{Features} \\
        \hline
         ISO/IEC 11172-3 and 13818-3 audio standards \\
         \hline
...
As attributes, it presents low operation frequency, low power consumption, and a compact hardware implementation, fitting economically in FPGAs and ASICs.
