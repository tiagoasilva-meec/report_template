...
This chapter addresses the state-of-the-art. It starts by presenting the ISO/IEC 11172-3 standard. Then, it describes the MPEG-1/2 Layers I/II encoders available in the market. At the end, it presents the tools used in this work, IOb-Soc and \textit{Versat}.
